...
void s21_bin_and(s21_big_decimal num_one, s21_big_decimal num_two, s21_big_decimal* result) {
  s21_bin_operators_cycle(num_one, num_two, result, s21_bin_operator_and); 
}

void s21_bin_or(s21_big_decimal num_one, s21_big_decimal num_two, s21_big_decimal* result) {
  s21_bin_operators_cycle(num_one, num_two, result, s21_bin_operator_or); 
}
void s21_bin_xor(s21_big_decimal num_one, s21_big_decimal num_two, s21_big_decimal* result) {
