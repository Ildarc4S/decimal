...
void s21_binary_div_cel(s21_big_decimal num_one, s21_big_decimal num_two, s21_big_decimal* result, s21_big_decimal* remainder);
void s21_binary_div(s21_big_decimal num_one, s21_big_decimal num_two, s21_big_decimal* result, int* sc);
#endif
